  ...
  <div class="masthead__inner-wrap">
    ...
    <div class="initial-content">
      var store = [{
        ...
        "excerpt":"1. 파이썬으로 풀어본 첫 번째 알고리즘 문제! 파이썬으로 풀어본 첫 번째 알고리즘 문제. 프로그래머스에 가입하면 무료로 다양한 알고리즘 문제를 풀어볼 수 있다. 알고리즘에 대해서 이해할 때 다음과 같이 이해했다. 어떤 문제를 해결하기 위해 공간 &amp; 시간복잡도를 최대한 낮춰 문제를 해결하는 방법 즉, 가장 효율적인 문제 해결 방법론 알고리즘을 잘 이해하고...","categories": ["Algorithm_Study"],
        "tags": ["jekyll","github","markdown"],
        "url": "http://localhost:4000/algorithm_study/01/",
        "teaser": null
      }]
